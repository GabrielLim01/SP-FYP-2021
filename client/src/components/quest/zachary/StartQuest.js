        ...
        if (!verifyLogin()) {
            ...
            return (
                <div className="container">
                    ...
                    <div className="segment box" style={{ paddingLeft: '380px', paddingTop: '30px' }}>
                        <div className="ui segment " style={{ width: '60%', height: '24em', backgroundColor: 'teal' }}>
                            <i
                                class="lightbulb icon"
                                style={{ paddingTop: '25px', color: 'white', fontSize: '35px' }}
                            ></i>

                            <h1 style={{ textAlign: 'center', color: 'white' }}> Quest: Technology</h1>
                            ...
                            <div className="ButtonIcon" style={{ paddingRight: '8px', paddingTop: '20px' }}>
                                <Button
                                    id="lol"
